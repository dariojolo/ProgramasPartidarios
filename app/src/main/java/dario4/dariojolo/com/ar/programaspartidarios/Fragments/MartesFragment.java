package dario4.dariojolo.com.ar.programaspartidarios.Fragments;
...
import dario4.dariojolo.com.ar.programaspartidarios.adapters.MyAdapter;
 ...
 */
public class MartesFragment extends Fragment implements RealmChangeListener<RealmResults<Programa>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_martes, container, false);
    ...
    private RealmResults<Programa> getAllProgramasR() {
        ...
        return realm.where(Programa.class).equalTo("martes", true).findAll();
    }
