 ...
 */
public class FmFragment extends Fragment implements RealmChangeListener<RealmResults<Programa>> {
    ...
    private RealmResults<Programa> getAllProgramasR() {
        ...
        return realm.where(Programa.class).equalTo("medio", "FM").findAll();
    }
