 ...
 */
public class ViernesFragment extends Fragment implements RealmChangeListener<RealmResults<Programa>> {
    ...
    private RealmResults<Programa> getAllProgramasR() {
        ...
        return realm.where(Programa.class).equalTo("viernes", true).findAll();
    }
