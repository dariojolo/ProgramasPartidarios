package dario4.dariojolo.com.ar.programaspartidarios.app;
    ...
    private void iniciarListaProgramas(){
        realm.executeTransaction(new Realm.Transaction(){
            ...
            public void execute(Realm realm) {
                Programa p1 = new Programa("A Todo Ciclón", R.drawable.atodociclon, "Oscar Sacco", "AM810","saccofutbol@gmail.com","No disponible","https://twitter.com/atodociclonsl","No disponible","No disponible",true,false,false,false,true,false,false,false,"Lunes y Viernes 19Hs","","AM","http://tunein.com/embed/player/s248138/",false,false,"ATodoCiclon",false,true,false);
