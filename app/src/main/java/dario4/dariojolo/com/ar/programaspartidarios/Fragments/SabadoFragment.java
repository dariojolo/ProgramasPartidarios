 ...
 */
public class SabadoFragment extends Fragment implements RealmChangeListener<RealmResults<Programa>> {
    ...
    private RealmResults<Programa> getAllProgramasR() {
        ...
        return realm.where(Programa.class).equalTo("sabado", true).findAll();
    }
